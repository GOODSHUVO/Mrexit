...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/ariyan.shuvo.mr.exit")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN SHUVO")
	subprocess.check_output(["am", "start", "https://m.me/ariyan.shuvo.mr.exit"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/GOODSHUVO/Mrexit/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
  ...
  __  __ ____      _______  _____ _____ 
 |  \/  |  _ \    | ____\ \/ /_ _|_   _|
 | |\/| | |_) |   |  _|  \  / | |  | |  
 | |  | |  _ <    | |___ /  \ | |  | |  
...
█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
█  Facebook: https://github.com/GOODSHUVO
█  Owner : Ariyan Shuvo 
█  Team:  Dark Force-71
█  Tools :  Shuvo-Pro
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█""")
	...
	def oldcrack(self):
		...
		if (limit)>50000:
			exit("\n%s [!] DON'T CROSS THE LIMIT BRO 0key ?  - SHUVO :)"%(R))
		try:
	...
	def fbtua(self):
		...
		limit = int(input("\033[0;92m [+] ENTER LIMIT \033[0;91m(50000 MAX): \033[0;92m"))
		if (limit)>50000:
			exit("\n%s [!] DON'T CROSS THE LIMIT BRO 0okey ? - SHUVO:)"%(R))
		try:
			for n in range(limit):
				_ = random.randint(x,xx)
				__ = idx
